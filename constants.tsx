...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 'sedai-velosa',
    name: 'Sedai Velosa — Model Two',
    category: 'Light Sport Aircraft (LSA)',
    description: '2 seats, 3+ hour range, 160 mph cruise. Seamless transition from ultralight to scalable mobility platform.',
    specs: ['LSA Category', '2 Seats', '160 mph Cruise', '3+ Hour Range'],
    imageUrl: 'https://images.unsplash.com/photo-1493238507129-15510bfad19a?auto=format&fit=crop&q=80&w=1200'
  }
];
